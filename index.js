...
function filterStudentsByGrade(students, grade) {
  ...
  const studentsFilterA = students.filter((student) => student.grade === grade);
  studentsFilterA.forEach((student) =>
    console.info(`cтудент ${student.name} має оцінку ${student.grade}`)
  );
}
...
function countVowelsAndConsonants(word) {
  ...
  // Скидаємо лічильники
  const rowVowels = "aeiou";
  for (const letter of word) {
    if (rowVowels.includes(letter.toLowerCase())) console.count("Голосна");
